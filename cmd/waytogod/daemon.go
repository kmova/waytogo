...
import (
	...
	apiserver "github.com/kmova/waytogo/api/server"
	"github.com/kmova/waytogo/api/server/middleware"
	"github.com/kmova/waytogo/api/server/router"
	systemrouter "github.com/kmova/waytogo/api/server/router/system"
	cliflags "github.com/kmova/waytogo/cli/flags"
	"github.com/kmova/waytogo/daemon"
	"github.com/kmova/waytogo/opts"
	flag "github.com/kmova/waytogo/pkg/mflag"
	"github.com/kmova/waytogo/pkg/pidfile"
	"github.com/kmova/waytogo/pkg/signal"
	"github.com/kmova/waytogo/pkg/jsonlog"
	"github.com/kmova/waytogo/pkg/listeners"
	...
	if configFile != "" {
		...
		if err != nil {
			if flags.IsSet(daemonConfigFileFlag) || !os.IsNotExist(err) {
				return nil, fmt.Errorf("unable to configure the WayToGo daemon with file %s: %v\n", configFile, err)
			}
		}

...
import (
	...
	"github.com/kmova/waytogo/cmd/waytogod/hack"
	"github.com/kmova/waytogo/pkg/system"
	"github.com/docker/libnetwork/portallocator"
)

const defaultDaemonConfigFile = "/etc/waytogo/daemon.json"
...
// that try to use any port allocated for the waytogo server.

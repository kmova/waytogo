...
import (
	...
	"github.com/kmova/waytogo/client/transport/cancellable"
	"github.com/kmova/waytogo/types"
	"github.com/kmova/waytogo/types/versions"
...
// head sends an http request to the WayToGo API using the method HEAD.
func (cli *Client) head(ctx context.Context, path string, query url.Values, headers map[string][]string) (*serverResponse, error) {
	return cli.sendRequest(ctx, "HEAD", path, query, nil, headers)
}

// getWithContext sends an http request to the WayToGo API using the method GET with a specific go context.
func (cli *Client) get(ctx context.Context, path string, query url.Values, headers map[string][]string) (*serverResponse, error) {
	return cli.sendRequest(ctx, "GET", path, query, nil, headers)
}

// postWithContext sends an http request to the WayToGo API using the method POST with a specific go context.
...
// put sends an http request to the WayToGo API using the method PUT.
...
// delete sends an http request to the WayToGo API using the method DELETE.
...
func (cli *Client) newRequest(method, path string, query url.Values, body io.Reader, headers map[string][]string) (*http.Request, error) {
	...
	// Add CLI Config's HTTP Headers BEFORE we set the WayToGo headers

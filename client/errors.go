...
var ErrConnectionFailed = errors.New("Cannot connect to the WayToGo daemon. Is the WayToGo daemon running on this host?")
...
// object (image, container, network, volume, …) is not found in the  WayToGo host.
func IsErrNotFound(err error) bool {
	te, ok := err.(notFound)
	return ok && te.NotFound()
}

// imageNotFoundError implements an error returned when an image is not in the WayToGo host.
...
// when an image is not found in the WayToGo host.
func IsErrImageNotFound(err error) bool {
	return IsErrNotFound(err)
}

// containerNotFoundError implements an error returned when a container is not in the WayToGo host.
...
// when a container is not found in the WayToGo host.
func IsErrContainerNotFound(err error) bool {
	return IsErrNotFound(err)
}

// networkNotFoundError implements an error returned when a network is not in the WayToGo host.
...
// when a network is not found in the WayToGo host.
func IsErrNetworkNotFound(err error) bool {
	return IsErrNotFound(err)
}

// volumeNotFoundError implements an error returned when a volume is not in the WayToGo host.
...
// when a volume is not found in the WayToGo host.

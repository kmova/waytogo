...
// that the WayToGo daemon is running.
//
...
var (
	errSystemNotSupported = fmt.Errorf("The WayToGo daemon is not supported on this platform.")
)

// Daemon holds information about the WayToGo daemon.
type Daemon struct {
	ID		string
	configStore	*Config
	shutdown	bool
